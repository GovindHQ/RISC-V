...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2b87.protoinst" -protoinst "protoinst_files/dopmidsem.protoinst" -log simulate.log
}
