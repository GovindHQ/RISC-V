...
export RDI_DATADIR="/home/govind/Vivado/2025.1/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dopmidsem xil_defaultlib.dopmidsem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dopmidsem -key {Behavioral:sim_1:Functional:dopmidsem} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2b87.protoinst" -protoinst "protoinst_files/dopmidsem.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/govind/Vivado/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dopmidsem.wdb xsim.dir libdpi.so)
