...
#
# Script generated by Vivado on Thu Oct 23 16:24:52 IST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dopmidsem.sh
...
#
# Usage        : dopmidsem.sh
#                dopmidsem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dopmidsem.sh [-reset_run]
#                dopmidsem.sh [-reset_log]
#                dopmidsem.sh [-help]
#
...
#                script (type 'dopmidsem.sh -help' for more information).
#
...
# script info
echo -e "dopmidsem.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dopmidsem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../Vivado/2025.1/data/rsb/busdef" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/5431/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/4e08/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/537f/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/d41f/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../Vivado/2025.1/data/rsb/busdef" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/5431/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/4e08/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/537f/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/d41f/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dopmidsem xil_defaultlib.glbl -o dopmidsem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dopmidsem_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/govind/Downloads/Superscalar/Superscalar.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dopmidsem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dopmidsem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dopmidsem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dopmidsem.sh [-help]\n\
Usage: dopmidsem.sh [-step]\n\
Usage: dopmidsem.sh [-lib_map_path]\n\
Usage: dopmidsem.sh [-reset_run]\n\
Usage: dopmidsem.sh [-reset_log]\n\
Usage: dopmidsem.sh [-keep_index]\n\
Usage: dopmidsem.sh [-noclean_files]\n\n\
