...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../Vivado/2025.1/data/rsb/busdef" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/5431/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/4e08/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/537f/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/d41f/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../Vivado/2025.1/data/rsb/busdef" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/5431/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/4e08/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/537f/hdl/verilog" +incdir+"../../../../Superscalar.gen/sources_1/bd/dopmidsem/ipshared/d41f/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dopmidsem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dopmidsem -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/govind/Downloads/Superscalar/Superscalar.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dopmidsem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
