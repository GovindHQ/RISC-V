...
module dopmidsem
  ...
  wire [31:0]IF_0_instr1;
  wire [31:0]IF_0_instr2;
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [31:0]InstrMem_0_instr1;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [31:0]InstrMem_0_instr2;
  wire [2:0]LSQ_0_FREE;
  ...
  dopmidsem_ID_RN_0_0 ID_RN_0
       (.ID_RN_MemRead_1(ID_RN_0_ID_RN_MemRead_1),
        ...
        .rs21(ID_0_rs21),
        .rs22(ID_0_rs22));
  dopmidsem_IF_0_0 IF_0
       (.PC1(IF_0_PC1),
        .PC2(IF_0_PC2),
        .clk(clk_1),
        .i1(InstrMem_0_instr1),
        .i2(InstrMem_0_instr2),
        .inst1(IF_0_instr1),
        .inst2(IF_0_instr2),
        .reset(reset_1));
  ...
  dopmidsem_InstrMem_0_0 InstrMem_0
       (.PC1(IF_0_PC1),
        .PC2(IF_0_PC2),
        .instr1(InstrMem_0_instr1),
        .instr2(InstrMem_0_instr2),
        .reset(reset_1));
